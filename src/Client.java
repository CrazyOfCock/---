...
public class Client extends JFrame {
    ...
    /** 默认端口号*/
    protected static final int PORT_NUM = Protocol.PORT_NUM;
    ...
    public Client() {
        ...
        input.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (loggedIn) {
                    // 以广播的方式发送出去，所有人可见
                    pw.println(Protocol.CMD_BCAST + input.getText());
                    // 发送后，发消息输入框置空
                    input.setText("");
                }
            }
    ...
    public void login() {
        ...
        try {
            ...
            // 现在假登录，不需要输入密码
            pw.println(Protocol.CMD_LOGIN + userName);
            loggedIn = true;
